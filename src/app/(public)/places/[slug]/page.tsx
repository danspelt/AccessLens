...
import { getPlaceBySlugOrId, looksLikeMongoObjectId } from '@/lib/places/resolve';
...
export default async function PlacePage({ params }: PlacePageProps) {
  ...
  const place = await getPlaceBySlugOrId(slugParam);

  if (!place) {
    notFound();
  }

  if (place.slug && looksLikeMongoObjectId(slugParam)) {
    permanentRedirect(`/places/${place.slug}`);
  }
